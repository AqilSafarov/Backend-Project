        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Desc2 = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Subtitle2 = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HomeOne", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MobileAppDetail", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AppImage = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    ...
                    WorkPeriodDetail = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    Address = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    Address2 = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    Email = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    Email2 = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    OpenTime = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    MondaySaturday = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    Friday = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    Sunday = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    CalendarEvents = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageBg = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    Title = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    Title2 = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    Title3 = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    Subtitle = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    Surame = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    Image = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Gallery_GalleryCategory_GalleryCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PageDetail_Page_PageId",
                        column: x => x.PageId,
                        principalTable: "Page",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SocialToTeamMember", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SocialToTeamMember_Social_SocialId",
                        column: x => x.SocialId,
                        principalTable: "Social",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SocialToTeamMember_TeamMember_TeamMemberId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Accordion", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Accordion_Service_ServiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Gallery_GalleryCategoryId",
                table: "Gallery",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SocialToTeamMember_SocialId",
                table: "SocialToTeamMember",
                column: "SocialId");

            migrationBuilder.CreateIndex(
                name: "IX_SocialToTeamMember_TeamMemberId",
                table: "SocialToTeamMember",
                column: "TeamMemberId");
